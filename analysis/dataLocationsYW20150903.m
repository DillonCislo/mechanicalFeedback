%mainDataDir = '/Users/Yuanwang/Desktop/Yuanwang Mechanical Feedback Image Analysis';
...
%--------- 20150603 Ban JubGFP 2.5d -----------12
i = i + 1;
%dataDir{i} = fullfile(mainDataDir, '20150603_Ban_JubGFP_2.5d');
dataDir{i} = fullfile(mainDataDir, 'Yuanwang, Ban clones analysis 20150903');
bareFnames{i} = {   '20150603_Ban_JubGFP_2.5d_No.2',...
                    '20150603_Ban_JubGFP_2.5d_No.1'};
description{i} = 'Ban_JubGFP';          
resolutions{i} = { 0.109,0.109 };
detectionChannel{i} = [1];
labels{i} = {'Jub','clone', 'arm'};

%--------- 20150121_Ban_JubGFP_2.5d ----------13
i = i + 1;
%dataDir{i} = fullfile(mainDataDir, '20150121_Ban_JubGFP_2.5d');
dataDir{i} = fullfile(mainDataDir, 'Yuanwang, Ban clones analysis 20150903');
bareFnames{i} = {   '20150121_Ban_JubGFP_2.5d_No.3',...
                    '20150121_Ban_JubGFP_2.5d_No.5',...
                    '20150121_Ban_JubGFP_2.5d_No.6'};
description{i} = 'Ban_JubGFP';          
resolutions{i} = { 0.100,0.100,0.100 };
detectionChannel{i} = [1];
labels{i} = {'Jub','arm', 'clone'};


%--------- 20150125_Ban_WtsGFP_2.5d ----------14
i = i + 1;
%dataDir{i} = fullfile(mainDataDir, '20150125_Ban_WtsGFP_2.5d');
dataDir{i} = fullfile(mainDataDir, 'Yuanwang, Ban clones analysis 20150903');
bareFnames{i} = {   '20150125_Ban_WtsGFP_2.5d_No.5',...
                    '20150125_Ban_WtsGFP_2.5d_No.6',...
                    '20150125_Ban_WtsGFP_2.5d_No.9',...
                    '20150125_Ban_WtsGFP_2.5d_No.10'};
description{i} = 'Ban_WtsGFP';          
resolutions{i} = { 0.100,0.109,0.109,0.110 };
detectionChannel{i} = [1];
labels{i} = {'Wts','arm', 'clone'};
